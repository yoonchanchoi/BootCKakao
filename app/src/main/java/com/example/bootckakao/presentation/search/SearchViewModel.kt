...
class SearchViewModel @Inject constructor(
    ...
    fun requestSearch(query: String) {
        viewModelScope.launch {
            Log.e("cyc","requestSearch")
            val imageDocumentList = requestSearchUseCase(query)
            Log.e("cyc","searchViewModel--requestSearch--imageDocumentList-->${imageDocumentList}")
    ...
    private fun addBookMark(imageDocumentEntity: ImageDocument) {
        viewModelScope.launch {
            addSaveImageDocumentEntityUseCase(imageDocumentEntity)
        }
    }

    private fun deleteBookMark(imageUrl: String) {
        viewModelScope.launch {
